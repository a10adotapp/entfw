...
func EmailAddress(v uint32) predicate.User {
...
func EmailAddressNotIn(vs ...uint32) predicate.User {
...
func EmailAddressGT(v uint32) predicate.User {
...
func EmailAddressLTE(v uint32) predicate.User {
